...
public class Cube extends Shape3D{
	...
	public Cube(boolean FacingOut) {
		if(!FacingOut)
		{
			...
			float[] cw_tex_verts = {
					1.0f*4/4, 1.0f/3, 1.0f*3/4, 1.0f/3, 1.0f*4/4, 2.0f/3, //Bottom Right, Bottom Left, Top Right
					1.0f*3/4, 1.0f/3, 1.0f*3/4, 2.0f/3, 1.0f*4/4, 2.0f/3, //Bottom Left, Top Left, Top Right
					1.0f*3/4, 1.0f/3, 1.0f*2/4, 1.0f/3, 1.0f*3/4, 2.0f/3,
					1.0f*2/4, 1.0f/3, 1.0f*2/4, 2.0f/3, 1.0f*3/4, 2.0f/3,
					1.0f*2/4, 1.0f/3, 1.0f*1/4, 1.0f/3, 1.0f*2/4, 2.0f/3,
					1.0f*1/4, 1.0f/3, 1.0f*1/4, 2.0f/3, 1.0f*2/4, 2.0f/3,
					1.0f*1/4, 1.0f/3, 0.0f, 1.0f/3, 1.0f*1/4, 2.0f/3,
					0.0f, 1.0f/3, 0.0f, 2.0f/3, 1.0f*1/4, 2.0f/3,
					1.0f*3/4, 0, 1.0f*2/4, 0, 1.0f*3/4, 1.0f/3,
					1.0f*2/4, 0, 1.0f*2/4, 1.0f/3, 1.0f*3/4, 1.0f/3,
					1.0f*3/4, 2.0f/3, 1.0f*2/4, 2.0f/3, 1.0f*3/4, 1.0f,
					1.0f*2/4, 2.0f/3, 1.0f*2/4, 1.0f, 1.0f*3/4, 1.0f,
			};
